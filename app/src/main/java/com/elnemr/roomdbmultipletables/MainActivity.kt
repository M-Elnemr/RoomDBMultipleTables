package com.elnemr.roomdbmultipletables

import android.os.Bundle
import android.util.Log
import androidx.appcompat.app.AppCompatActivity
import androidx.lifecycle.lifecycleScope
import com.elnemr.roomdbmultipletables.db.SchoolDataBase
...
class MainActivity : AppCompatActivity() {
    private val dao by lazy { SchoolDataBase.getInstance(this).schoolDao }
...
//        testDatabase()
    ...
    private fun testDatabase() {
        ...
        lifecycleScope.launch {
            ...
            val schoolWithStudents = dao.getSchoolAndStudentsWithSchoolName("Kotlin School")

            Log.d("TAG", "schoolWithDirector: $schoolWithDirector")
            Log.d("TAG", "schoolWithStudents: $schoolWithStudents")
        }
    }
}